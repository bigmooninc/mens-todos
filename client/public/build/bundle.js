...
var app = (function () {
    ...
    const file = "src/components/todos/Todos.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			main = element("main");
    			add_location(styles, file, 17, 0, 329);
    			add_location(h1, file, 18, 0, 340);
    			add_location(main, file, 19, 0, 377);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self) {
    	...
    	onMount(async () => {
    		try {
    			const res = await axios$1.get("/api/todos");
    ...
    const file$1 = "src/components/auth/Login.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 33, 2, 1202);
    ...
    const file$2 = "src/components/auth/Register.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input3, file$2, 43, 4, 1538);
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "class", "bg-red-800 hover:bg-red-900 transition-bg transition-500 svelte-gclo23");
    			add_location(button, file$2, 47, 4, 1652);
    			attr_dev(form, "class", "flex flex-col w-full");
    			add_location(form, file$2, 33, 2, 1212);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "text-red-700 hover:underline transition-500");
    			add_location(a, file$2, 55, 4, 1827);
    			attr_dev(p, "class", "svelte-gclo23");
    			add_location(p, file$2, 53, 2, 1790);
    			attr_dev(div, "class", "max-w-xs w-full mx-auto h-screen flex flex-col justify-center\n  items-center pb-20");
    			add_location(div, file$2, 29, 0, 1071);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Router extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$4, safe_not_equal, { basepath: 3, url: 4 });
    ...
    class Link extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$6, safe_not_equal, { to: 6, replace: 7, state: 8, getProps: 9 });
    ...
    class NavLink extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$7, safe_not_equal, { to: 0 });
